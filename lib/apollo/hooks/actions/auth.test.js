...
describe('Auth actions', () => {
  ...
  describe('useSignIn', () => {
    test('should call useMutation', () => {
      ...
      // Act
      const [mutateFunction, state] = useSignIn();
  ...
  describe('useSignUp', () => {
    test('should call useMutation', () => {
      ...
      // Act
      const [mutateFunction, state] = useSignUp();
  ...
  describe('useSignOut', () => {
    test('should call useMutation', () => {
      ...
      // Act
      const [mutateFunction, state] = useSignOut();
  ...
  describe('usePasswordRecovery', () => {
    test('should call useMutation', () => {
      ...
      // Act
      const [mutateFunction, detail, error] = usePasswordRecovery();
